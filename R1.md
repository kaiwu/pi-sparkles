...
and [`R2.md`](R2.md#breadth-first-policy-and-active-queue). Rank 1
`pi_stock_technicals`, `pi_finance_sources`, and `pi_trade_plan` are now
Experimental; the active next goal is `pi_order_simulator`, followed by
`pi_finance_dataset`.
