...
and [`R2.md`](R2.md#breadth-first-policy-and-active-queue). Ranks 1 through 15
...
dossier inspection/calculation slice. Rank-16 `pi_company_profile` is the sole
active source-lane item.
...
| `pi_company_profile` (**Selected — Session 17 rank 16**) | P1 | Active raw source lane for exact issuer/listing identity, business description, exchanges, securities/share facts, fiscal calendar, named effective-dated classification, management facts, and primary-source links. Provider and first-track scope must be reviewed before a plugin directory is created; no fallback or profile-to-dossier judgment. | `/company`, `company_profile`, `company_entities` |
