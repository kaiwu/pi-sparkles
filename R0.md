...
| `finance_strategy` | Draft | Shared research and trade-plan language | **Course gates `CG-RISK`, `CG-SWING`, `CG-DAY`, and `CG-QUANT` (Open).** Falsifiable hypotheses, universes, versioned feature predicates, entries/exits/stops/targets, holding horizons, sizing constraints, invalidation, signal evaluation, and planned-versus-observed transitions without broker effects |
