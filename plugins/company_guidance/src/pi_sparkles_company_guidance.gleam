...
import pi/schema
import pi/tool
import pi_sparkles_company_guidance/domain
...
pub fn extension(api: pi.ExtensionApi) -> Promise(Nil) {
  tool.register(
    api,
    "company_guidance_compare",
    "Calculate company-guidance comparison",
    "Read one exact content-bound request from a caller-owned UTF-8 file and perform only the named exact-decimal company-guidance comparison mechanics with complete source leaves, context proof, expression, and canonical receipt",
