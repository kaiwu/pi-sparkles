...
import pi/schema
import pi/tool
import pi_sparkles_cn_stock_valuation/domain
...
pub fn extension(api: pi.ExtensionApi) -> Promise(Nil) {
  tool.register(
    api,
    "cn_inspect_valuation",
    "Calculate CN enterprise-to-equity valuation",
    "Read one exact content-bound request from a caller-owned UTF-8 file and perform only the named exact-decimal CN enterprise-to-equity valuation mechanics with complete source leaves, context proof, expression, and canonical receipt",
