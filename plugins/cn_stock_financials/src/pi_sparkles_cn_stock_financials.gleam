...
import pi/schema
import pi/tool
import pi_sparkles_cn_stock_financials/domain
...
pub fn extension(api: pi.ExtensionApi) -> Promise(Nil) {
  tool.register(
    ...
    "Calculate CN financial metric",
    "Read one exact content-bound request from a caller-owned UTF-8 file and perform only the named exact-decimal CN financial metric mechanics with complete source leaves, context proof, expression, and canonical receipt",
