...
The implemented `cn_stock_watch_query` tool validates a bounded,
SHA-256-bound CNINFO/exchange receipt packet for one exact mainland listing.
It retains original-language labels, event/publication/retrieval/effective date
semantics, corrections, coverage, source failures, entitlement and hashes.
