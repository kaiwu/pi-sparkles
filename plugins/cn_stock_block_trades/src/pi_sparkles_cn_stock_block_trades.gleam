...
import pi/schema
import pi/tool
import pi_sparkles_cn_stock_block_trades/domain
...
pub fn extension(api: pi.ExtensionApi) -> Promise(Nil) {
  tool.register(
    api,
    "cn_block_trade_comparison",
    "Calculate CN block-trade premium/discount",
    "Read one exact content-bound request from a caller-owned UTF-8 file and perform only the named exact-decimal CN block-trade premium/discount mechanics with complete source leaves, context proof, expression, and canonical receipt",
