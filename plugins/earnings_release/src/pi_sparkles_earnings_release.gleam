...
import pi/schema
import pi/tool
import pi_sparkles_earnings_release/domain
...
pub fn extension(api: pi.ExtensionApi) -> Promise(Nil) {
  tool.register(
    api,
    "earnings_release_compare",
    "Calculate earnings-release comparison",
    "Read one exact content-bound request from a caller-owned UTF-8 file and perform only the named exact-decimal earnings-release comparison mechanics with complete source leaves, context proof, expression, and canonical receipt",
