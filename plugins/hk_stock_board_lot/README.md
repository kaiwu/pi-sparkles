...
The package now exposes `hk_board_lots` and `hk_board_lot_record`. Both use the
shared versioned `hk_stock_board_lot_v1` evidence packet through a caller-selected
