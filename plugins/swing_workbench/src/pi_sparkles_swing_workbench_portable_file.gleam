...
@external(javascript, "./pi_sparkles_swing_workbench/effect/portable_file_ffi.mjs", "read_text")
fn read_raw(
  path: String,
  maximum_bytes: Int,
  signal: Dynamic,
...
@external(javascript, "./pi_sparkles_swing_workbench/effect/portable_file_ffi.mjs", "replace_if_unchanged")
fn replace_raw(
  path: String,
  expected: String,
  replacement: String,
