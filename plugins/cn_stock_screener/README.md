...
Status: **Tier 4 ProductUseful** · CN point-in-time projection implementation
...
The `cn_stock_screen` Pi tool accepts one bounded content-hashed JSON import,
verifies both canonical replay manifests, and delegates the pure predicate fold
to `finance_quant`.
