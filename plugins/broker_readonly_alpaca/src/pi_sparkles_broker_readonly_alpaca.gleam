...
pub fn extension(api: pi.ExtensionApi) -> Promise(Nil) {
  tool.register(
    ...
    "Review an explicit Alpaca read-only capability packet",
    "Validate bounded normalized Alpaca account, position, order, fill, capability, entitlement, and lifecycle evidence from an explicitly selected external read-only capability",
    "Alpaca is a required external dependency. This plugin ships no SDK, credentials, adapter, transport, or broker mutation surface.",
