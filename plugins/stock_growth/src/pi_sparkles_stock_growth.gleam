...
import pi/schema
import pi/tool
import pi_sparkles_stock_growth/domain
...
pub fn extension(api: pi.ExtensionApi) -> Promise(Nil) {
  tool.register(
    ...
    "Read one exact content-bound request from a caller-owned UTF-8 file and perform only the named exact-decimal growth metric mechanics with complete source leaves, context proof, expression, and canonical receipt",
