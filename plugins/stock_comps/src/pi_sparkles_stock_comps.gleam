...
import pi/schema
import pi/tool
import pi_sparkles_stock_comps/domain
...
pub fn extension(api: pi.ExtensionApi) -> Promise(Nil) {
  tool.register(
    api,
    "inspect_comparable_table",
    "Calculate comparable-company ratio",
    "Read one exact content-bound request from a caller-owned UTF-8 file and perform only the named exact-decimal comparable-company ratio mechanics with complete source leaves, context proof, expression, and canonical receipt",
