...
pub fn exact_hk_receipts_produce_complete_classification_test() {
...
pub fn provider_identity_and_complete_coverage_are_mandatory_test() {
  ...
  let wrong_listing = query.Input(..signed, code: "00001")
...
pub fn changed_hk_projection_fails_its_original_digest_test() {
  let signed = input(gap_receipt.Complete)
...
fn input(pagination: gap_receipt.Pagination) -> query.Input {
  ...
  let unsigned =
    query.Input(
      venue: "hk",
      board: hk_identity.MainBoard,
      share_class: hk_identity.OrdinaryShare,
      currency: hkd,
      code: "00700",
      instrument_id: "hkex:00700",
      listing_start: civil(2026, 1, 1),
      listing_end: None,
      listing_evidence: "authority:listing:00700:XHKG:2026",
