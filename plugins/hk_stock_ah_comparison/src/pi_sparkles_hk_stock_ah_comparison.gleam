...
import pi/schema
import pi/tool
import pi_sparkles_hk_stock_ah_comparison/domain
...
pub fn extension(api: pi.ExtensionApi) -> Promise(Nil) {
  tool.register(
    api,
    "hk_ah_price_comparison",
    "Calculate A/H price comparison",
    "Read one exact content-bound request from a caller-owned UTF-8 file and perform only the named exact-decimal A/H price comparison mechanics with complete source leaves, context proof, expression, and canonical receipt",
