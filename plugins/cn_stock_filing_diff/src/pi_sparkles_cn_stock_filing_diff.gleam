...
import pi/schema
import pi/tool
import pi_sparkles_cn_stock_filing_diff/domain
...
pub fn extension(api: pi.ExtensionApi) -> Promise(Nil) {
  register_page(api, "cn_diff_filings", "Compare exact filing versions")
  register_page(api, "cn_list_changed_sections", "List changed filing sections")
  tool.register(
    api,
    "cn_drill_change",
