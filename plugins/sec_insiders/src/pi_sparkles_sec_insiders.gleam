...
import pi/schema
import pi/tool
import pi_sparkles_sec_insiders/domain
...
fn register_drill(api: pi.ExtensionApi) -> Nil {
  tool.register(
    api,
    "sec_insider_record",
    "Drill one SEC Forms 3, 4, and 5 record",
    "Reread the same exact content-bound import and return one complete record with source fields and correction lineage",
    "Use the packet hash and recordId returned by sec_insider_filings; no latest-record or preferred-source choice is made",
