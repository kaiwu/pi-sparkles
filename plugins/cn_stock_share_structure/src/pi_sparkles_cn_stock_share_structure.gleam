...
import pi/schema
import pi/tool
import pi_sparkles_cn_stock_share_structure/domain
...
fn register_drill(api: pi.ExtensionApi) -> Nil {
  tool.register(
    api,
    "cn_share_structure_record",
    "Drill one CN share structure record",
    "Reread the same exact content-bound import and return one complete record with source fields and correction lineage",
    "Use the packet hash and recordId returned by cn_share_structure; no latest-record or preferred-source choice is made",
