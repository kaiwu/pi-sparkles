...
import pi/schema
import pi/tool
import pi_sparkles_stock_valuation/domain
...
pub fn extension(api: pi.ExtensionApi) -> Promise(Nil) {
  tool.register(
    api,
    "inspect_valuation",
    "Calculate enterprise-to-equity valuation",
    "Read one exact content-bound request from a caller-owned UTF-8 file and perform only the named exact-decimal enterprise-to-equity valuation mechanics with complete source leaves, context proof, expression, and canonical receipt",
