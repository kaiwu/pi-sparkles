...
The package now exposes `cn_share_pledges` and `cn_share_pledge_record`. Both use the
shared versioned `cn_stock_pledges_v1` evidence packet through a caller-selected
